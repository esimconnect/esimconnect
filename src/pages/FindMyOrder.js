        ...
        <div className={styles.card} style={{ maxWidth: '520px' }}>
          ...
          {orders.length === 0 ? (
            <div style={{
              ...
              <div style={{ fontWeight: 700, marginBottom: '8px' }}>No orders found</div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                    <div>
                      ...
                      <div style={{ fontSize: '12px', color: 'var(--muted)' }}>
                        {order.package_title} · {order.data_amount} · {order.validity_days} days
                      </div>
                      <div style={{ fontSize: '11px', color: 'var(--muted)', marginTop: '2px' }}>
                        Order: {order.order_code} · {new Date(order.created_at).toLocaleDateString()}
                      </div>
                    </div>
